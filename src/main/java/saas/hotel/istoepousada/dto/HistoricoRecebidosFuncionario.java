...
@Schema(description = "Histórico de recebidos do funcionário (pagamentos vinculados ao histórico_funcionario)")
public record HistoricoRecebidosFuncionario(
        @Schema(description = "ID do registro") Long id,
        @Schema(description = "Histórico do funcionário vinculado") HistoricoFuncionario historicoFuncionario,
        ...
        @Schema(description = "Data/hora pagamento")
        @JsonFormat(pattern = "dd/MM/yyyy HH:mm")
    ...
    public static HistoricoRecebidosFuncionario mapHistoricoRecebidosFuncionario(ResultSet rs)
        ...
        return new HistoricoRecebidosFuncionario(
                ...
                new TipoPagamento(rs.getLong("tipo_pagamento_id"), rs.getString("tipo_pagamento_descricao")),
