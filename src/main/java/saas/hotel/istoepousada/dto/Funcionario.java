...
public record Funcionario(Long id, Pessoa pessoa, LocalDate dataAdmissao, Objeto cargo) {
  ...
  public static Funcionario mapFuncionario(ResultSet rs, String prefix) throws SQLException {
    return new Funcionario(
        ...
        new Objeto(rs.getLong(prefix + "cargo_id"), rs.getString(prefix + "cargo_nome")));
  }
}
