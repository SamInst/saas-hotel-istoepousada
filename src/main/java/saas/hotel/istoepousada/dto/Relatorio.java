...
public record Relatorio(
        ...
        @Schema(description = "Saldo histórico em dinheiro") Double valorHistoricoDinheiro,
        @Schema(description = "Indica se é despesa pessoal") Boolean despesaPessoal) {
  ...
  public static Relatorio mapRelatorio(ResultSet rs) throws SQLException {
    ...
    LocalDateTime dataHora =
      ...
      Double valorHistorico = rs.getObject("valor_historico_dinheiro") != null
      ...
      return new Relatorio(
            ...
            valorHistorico,
            rs.getObject("despesa_pessoal", Boolean.class));
  }
  ...
  public record RelatorioRequest(
          ...
          @Schema(description = "Se true, indica despesa pessoal", example = "false")
