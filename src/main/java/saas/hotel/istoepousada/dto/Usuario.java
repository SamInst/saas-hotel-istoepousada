...
public record Usuario(@NotNull Long id, @NotNull String username, @NotNull Boolean bloqueado) {
  public record Id(@NotNull Long id) {}

  public record Request(@NotNull String username, @NotNull String senha) {}
