...
public record Hospedagem(
  ...
  public record Calcular(
      Long categoria_id, List<LocalDate> datas_nascimento, LocalDate checkin, LocalDate checkout) {}

  public record Valores(Float valor_pago, Float valor_pendente, Float valor_total) {}
