...
public class LocalidadeController {
  ...
  @Operation(
          ...
          description = "Retorna os estados vinculados a um país (fkPais) para preencher o combobox de estado."
  )
  @ApiResponses({
          @ApiResponse(
                  responseCode = "200",
  ...
  public ResponseEntity<List<Objeto>> listarEstadosPorPais(
          @Parameter(description = "ID do país (fk_pais)", example = "1", required = true)
          @PathVariable Long fkPais
  ) {
  ...
  @Operation(
          ...
          description = "Retorna os municípios vinculados a um estado (fkEstado) para preencher o combobox de município."
  )
  @ApiResponses({
          @ApiResponse(
                  responseCode = "200",
