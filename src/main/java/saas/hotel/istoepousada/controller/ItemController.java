...
public class ItemController {
  ...
  @Operation(
          ...
          description = "Busca itens com filtros opcionais de id, termo, categoria e período de cadastro.")
  ...
  @ApiResponses({
          @ApiResponse(
                  ...
                  @Content(
                          ...
                          array = @ArraySchema(schema = @Schema(implementation = Item.HistoricoPreco.class)))),
          @ApiResponse(responseCode = "404", description = "Item não encontrado")
  })
  @GetMapping("/item/{id}/historico-preco")
  public List<Item.HistoricoPreco> listarHistoricoPreco(
          @Parameter(description = "ID do item", example = "85", required = true)
  ...
  @ApiResponses({
          @ApiResponse(
                  ...
                  @Content(
                          mediaType = MediaType.APPLICATION_JSON_VALUE,
                          array = @ArraySchema(schema = @Schema(implementation = Item.HistoricoReposicao.class)))),
          @ApiResponse(responseCode = "404", description = "Item não encontrado")
  })
  ...
  @ResponseStatus(HttpStatus.NO_CONTENT)
  public void atualizarCategoria(@PathVariable Long id, @RequestBody CategoriaItem.Request request) {
