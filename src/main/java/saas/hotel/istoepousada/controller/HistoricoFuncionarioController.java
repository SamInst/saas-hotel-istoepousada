...
@Tag(name = "Histórico do Funcionário", description = "Endpoints de histórico de cargo e salário do funcionário.")
@RestController
...
public class HistoricoFuncionarioController {
    ...
    @Operation(summary = "Buscar histórico por id", description = "Retorna um registro de histórico pelo id.")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public HistoricoFuncionario criar(
        ...
        Float salario = body.get("salario") == null ? null : ((Number) body.get("salario")).floatValue();
