...
//
// @Tag(name = "Veículos", description = "Cadastro de veículos e vínculo com pessoas.")
// @RestController
...
//          Observação: por causa do UNIQUE(veiculo_id), um veículo só pode estar vinculado a uma
// pessoa por vez.
...
//
//          Observação: por causa do UNIQUE(veiculo_id), se o veículo estiver vinculado a outra
// pessoa,
