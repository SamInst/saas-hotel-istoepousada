...
public class UsuarioController {
    ...
    public Page<Usuario> listar(
            ...
            @Parameter(description = "Username para busca (ILIKE)")
            @RequestParam(required = false)
            String username,
                    ...
                    @Content(
                            ...
                            @ExampleObject(
                                    ...
                                    value =
                                            ...
                                            """)))
            @Valid @RequestBody Usuario.Request request) {
                    ...
                    @Content(
                            ...
                            @ExampleObject(
                                    ...
                                    value =
                                            ...
                                            """)))
            @Valid @RequestBody Usuario.Update update) {
    ...
    @Operation(
            ...
            description = "Valida as credenciais de um usuário.")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
