...
@Tag(name = "Recebidos do Funcionário", description = "Endpoints de recebimentos vinculados ao histórico do funcionário.")
@RestController
...
public class HistoricoRecebidosFuncionarioController {
    ...
    @Operation(summary = "Inserir recebido (multipart)", description = "Insere um recebido com comprovante opcional.")
    @ApiResponses({
    ...
    public HistoricoRecebidosFuncionario inserir(
        ...
        HistoricoRecebidosFuncionario entity =
                new HistoricoRecebidosFuncionario(
                        new HistoricoRecebidosFuncionario.HistoricoFuncionario(recebido.historicoFuncionarioId()),
    ...
    @Operation(summary = "Atualizar recebido (multipart)", description = "Atualiza um recebido com comprovante opcional.")
    @ApiResponses({
    ...
    public HistoricoRecebidosFuncionario atualizar(
            @Parameter(description = "ID do recebido", example = "1", required = true) @PathVariable Long id,
