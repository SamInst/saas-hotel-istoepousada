...
public class VeiculoService {
     ...
     *
     * Observação:
     * - por causa do UNIQUE(veiculo_id), se o veículo estiver em outra pessoa, o vínculo será movido
     *   para a pessoa informada e marcado como ativo/inativo conforme parâmetro.
     */
    @Transactional
