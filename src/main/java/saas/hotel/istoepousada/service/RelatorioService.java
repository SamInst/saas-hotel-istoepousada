...
public class RelatorioService {
  ...
  /**
   * Registra um relatório (lançamento financeiro) para um pagamento JÁ criado.
   * Usado para gerar um relatório automaticamente sempre que um pagamento é adicionado.
   */
//  @Transactional
