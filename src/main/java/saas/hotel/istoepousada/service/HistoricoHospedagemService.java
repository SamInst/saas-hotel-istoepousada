...
public class HistoricoHospedagemService {
  ...
  /**
   * Ajuste das regras de data: - dataInicio informado e dataFim nulo: busca de dataInicio em diante
   * (>= dataInicio) - dataFim informado e dataInicio nulo: busca de dataFim pra trás (<= dataFim) -
