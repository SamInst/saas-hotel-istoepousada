...
public class RelatorioRepository {
    ...
    public RelatorioRepository(JdbcTemplate jdbcTemplate, PagamentoRepository pagamentoRepository, PessoaRepository pessoaRepository) {
    ...
    public Relatorio.Extrato buscar(
        ...
        List<LocalDate> dias =
                jdbcTemplate.query(
                        diasSql,
                        (rs, rowNum) -> rs.getObject("dia", LocalDate.class),
                        diasParams.toArray());
                ...
                jdbcTemplate.query(
                        ...
                        (rs, rowNum) -> {
                            ...
                            Quarto.Descricao quarto =
                                    quartoRowId == null
                                            ? null
                                            : new Quarto.Descricao(
                                            quartoRowId,
                                            rs.getString("quarto_descricao"));

                            Pagamento pagamento =
                                    pagamentoId == null ? null
                                            : new Pagamento(
                                            pagamentoId,
        ...
        Map<LocalDate, Float> totalEntradaDiaMap = buscarTotaisEntradaPorDia(where.toString(), params, dias);

        Map<LocalDate, Float> totalSaidaDiaMap = buscarTotaisSaidaPorDia(where.toString(), params, dias);
        ...
        return new Relatorio.Extrato(
                pagamentos,
                new PageImpl<>(diarias, pageable, totalDias));
    }
    ...
    public Relatorio update(Relatorio.Update relatorio) {
        ...
        Double valorHistoricoDinheiro =
                recalcularHistoricoDinheiro(relatorioAntigo, relatorio.valor());
