...
public class CategoriaRepository {
    ...
    public Map<Long, List<Categoria.ModeloFixo>> buscaModeloPrecoFixoSazonalidade(List<Long> sazonIds) {
        if (sazonIds == null || sazonIds.isEmpty()) return Map.of();
        String in = String.join(",", Collections.nCopies(sazonIds.size(), "?"));
    ...
    public double calcularPrecoDiaria(
        ...
        List<Categoria.ModeloFixo> modelosFixo =
                activeSazonId != null ? sazonalidadeModelosPrecoFixo.getOrDefault(activeSazonId, List.of()) : List.of();
