...
public class VeiculoRepository {
    ...
    public Optional<Veiculo> findById(Long id) {
        try {
            String sql =
                    ...
                    WHERE id = ?
                    """;
            return Optional.ofNullable(jdbcTemplate.queryForObject(sql, (rs, rowNum) -> mapVeiculo(rs), id));
     ...
     *
     * Regras:
     * - UNIQUE(veiculo_id) => um veículo só pode estar ligado a uma pessoa por vez
     * - Ao vincular, setamos vinculo_ativo=true
     * - Se o veículo já estiver vinculado a outra pessoa, o vínculo será "movido" para a nova pessoa
     */
    @Transactional
